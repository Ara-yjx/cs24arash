...
// (new main function and small change to test3 for UCSB CS 24,
//  by cmc 10/5/2015)
//
...
int test3( )
{
        ...
        if (char_ptr[i] == 'x')
	{
        ...
        return 0; // cmc change, was return POINTS[3] / 4;
	}
...
int main(int argc, char *argv[]) {
    ...
    if (argc > 1) {
        switch (argv[1][0]) {
            case '1':
                result = run_a_test(1, DESCRIPTION[1], test1, POINTS[1]);
                break;
            case '2':
                result = run_a_test(2, DESCRIPTION[2], test2, POINTS[2]);
                break;
            case '3':
                result = run_a_test(3, DESCRIPTION[3], test3, POINTS[3]);
                break;
            default:
